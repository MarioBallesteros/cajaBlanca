...
import static es.ieslavereda.POO.ClasesChess.model.Cell.CellColor.*;
...
public class Cell implements Serializable {
    ...
    public void hightLight() {
        if(piece!=null)
            color= (originalColor==WHITE_CELL)? CellColor.HIGHTLIGHT_KILL_WHITE:HIGHTLIGHT_KILL_BLACK;
        else
